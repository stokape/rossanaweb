        ...
        <div className="flex gap-4">
          {entries.map(([platform, url]) => (
            <a
              ...
              aria-label={platform}
              className="flex items-center gap-2 rounded-badge bg-white px-4 py-2 text-sm font-medium capitalize text-rossana-red shadow-soft hover:text-rossana-red-dark"
            >
